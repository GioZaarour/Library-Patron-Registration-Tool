...
function createNewPatron($patronArrayObj) {
  ...
  $patronagency = $patronArrayObj['patronagency'];
...
function createOnlinePatron($patronArrayObj) {
  ...
  $query_string .='","homeLibraryCode": "';
  $query_string .= $homelibrary;
  $query_string .='","fixedFields": {"126": {"label": "Agency Code *", "value": "2"} }';
    
  //$query_string .='","code": "';
  //$query_string .= '2'; //$patronagency
  //$query_string .= '", "Agency": {"code": "2", "display": " "}';      
...
function getNumberOfOnlineRegistrations() {
  ...
  $query_string = '{
    ...
    "expr": {
      "op": "has",
      "operands": [
        "Created via Online Registration",
        ""
      ]
    }
  }';
