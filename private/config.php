...
define('institutionName', 'Glendale Public Library');

// URL of your App Server
define('appServer', 'pgpl.iii.com'); // example app.mpl.on.ca

// API Version you are on
define('apiVer', '5');

// API Key
define('apiKey', 'zsNNAK2v4pON3Lwnu+5MWUnjjkCS');

// API Secret
define('apiSecret', 'glendale');

// Password to access the stats page.
define('patronStatsSecret', 'patronstatsGlendaleCA'); // Secret password to access statistics page.
...
define ('recaptchaSiteKey', '6LcJFeAUAAAAAI2TMLv3oWeZr5tD2TGX7Rw0szYN');

// set to 1 to use google analytics.  You need to enter in your GA property ID below.
define ('useGoogleAnalytics', '0');
...
define ("bingMapsKey", "ArcB0DhXucd3kZmbV5-ql5rfQWe-ErHO-AU91rtPcVstjCZAaxH0qAsSk7otFdzK");
//OR USE THIS IF THE ABOVE KEY DOESNT WORK AtXj98IXhIp8jmODLhId5at8kaeSEmP3CGcAY43NWxQDkvaCfBTBWLiCwC2vPlq5
...
define ('verifyCatchment', '0');
//GLENDALE: NOT USING CATCHMENT BOUNDARIES BECAUSE ONLY CRITERIA IS THAT PATRON BE LOCATED IN CALIFORNIA, WHICH IS THE ONLY STATE OPTION ON THE FORM
...
define ('catchmentFailedRedirectPage', '');
//ENTER REDIRECT PAGE ABOVE
...
define("renewedToday", "Thank-you for updating your card with GPL.");
...
define("mailFrom", "noreply@eglendalelac.org");
...
//FOLLOWING CODE IS NOT IN USE (until database settings around line 130)
...
Glendale Public Library please enter your email address below.");

// text emailed to patron showed before confirmation link
define("emailStart", "You've indicated that you would like to receive email from Glendale Public Library,\r\nPlease click on the following URL to verify your email address: ");
...
define('dbport', '1032');
define('dbname', 'iii');
define('dbhost', 'pgpl.iii.com'); //52.34.185.85 192.168.176.17 pgpl.iii.com
define('dbuser', 'dzcentral');
define('dbpassword', 'dzcentral');
