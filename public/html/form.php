...
<head>
    ...
    <!-- was previously content="width=device-width, initial-scale=1" but changed it so Personal Details form works on mobile-->
...
<fieldset>
                ...
                <input type="text" name="first_name" placeholder="" autocomplete="off" style="margin-bottom: 10px" onkeyup="this.value=this.value.toUpperCase()"/>
                <div class="form_labels">Last Name</div>
                <input type="text" name="last_name" placeholder="" id="last_name" autocomplete="mpl_lname_v1.0" style="margin-bottom: 10px" onkeyup="this.value=this.value.toUpperCase()"/>
                ...
                <input type="text" name="street" placeholder="" autocomplete="mpl_street_v1.0" style="margin-bottom: 10px" onkeyup="this.value=this.value.toUpperCase()"/>
                <div class="form_labels">Town or City</div>
                <input type="text" name="city" placeholder="" autocomplete="mpl_city_v1.0" style="margin-bottom: 10px" onkeyup="this.value=this.value.toUpperCase()"/>
                ...
                <input type="text" name="postalcode" placeholder="" autocomplete="mpl_postal_v1.0" style="margin-bottom: 10px" onkeyup="this.value=this.value.toUpperCase()"/>


                <h2 class="fs-title">Contact Information</h2>
                <h3 class="fs-subtitle">Please provide your email address, phone number, and how you would like to be contacted. </h3>
                <!-- <h3 class="fs-subtitle"> See our <a href="https://www.mpl.on.ca/policy" target="_blank">privacy policy</a> to learn how we use this information.</h3> -->
                ...
                <div class="form-group">
                    ...
                    <div class="dropdown">
                        <select class="form-control input-small" name="homelibrary" autocomplete="mpl_homelibrary_v1.0" style="height: 46px;" id="homelibrary">
                            <option value="gb">Brand Library</option>
                            <option value="gc" selected="">Central Library</option>
                            <option value="gg">Grandview Library</option>
                            <option value="gh">Chevy Chase Library</option>
                            <option value="gl">Library Connection @ Adams Square</option>
                            <option value="gm">Montrose Library</option>
                            <option value="gp">Pacific Park Library</option>
                            <option value="gv">Casa Verdugo Library</option>
                        </select>
                        
                        <?php
                        if(isset($_POST['homelibrary']))
